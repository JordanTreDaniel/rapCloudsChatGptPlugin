...
# and want to access the openapi.json when you run the app locally at http://0.0.0.0:4444/sub/openapi.json.
import os
...
# Create a sub-application, in order to access just the upsert and query endpoints in the OpenAPI schema, found at http://0.0.0.0:4444/sub/openapi.json when the app is running locally
sub_app = FastAPI(
